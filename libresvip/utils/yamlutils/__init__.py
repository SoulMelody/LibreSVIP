...
try:
    ...
    try:
        from yaml_rs import dumps as dump_yaml_1_2
        from yaml_rs import loads as load_yaml_1_2
    except ImportError:
        try:
            import io
            ...
            # The following functions are adapted from https://github.com/kislyuk/yq/.
