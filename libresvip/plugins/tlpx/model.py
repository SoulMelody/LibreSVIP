...
class TuneLabTrack(BaseModel):
    ...
    export_channels: int = Field(1, alias="exportChannels")


class TuneLabEditorInfo(BaseModel):
    playhead_pos: float = Field(0.0, alias="playheadPos")
...
class TuneLabProject(BaseModel):
    ...
    editor_info: TuneLabEditorInfo = Field(default_factory=TuneLabEditorInfo, alias="editorInfo")
