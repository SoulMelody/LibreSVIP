...
jinja_env.add_template(
    "nn",
    """\
{{ nn_project.info_line.tempo }} {{ nn_project.info_line.time_signature.numerator }} {{ nn_project.info_line.time_signature.denominator }} {{ nn_project.info_line.bar_count }} {{ nn_project.info_line.version }} 0 0 0 0 0
