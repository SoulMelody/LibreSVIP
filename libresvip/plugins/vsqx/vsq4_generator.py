        ...
        music_controls.extend(
            [
                Vsq4MCtrl(
                    ...
                    attr=Vsq4TypeParamAttr(
                        type_param_attr_id=Vsq4ParameterNames.DYN.value,
                        value=point.y,
                    ),
                )
        ...
        music_controls.extend(
            [
                Vsq4MCtrl(
                    pos_tick=point.x + tick_prefix,
                    attr=Vsq4TypeParamAttr(
                        type_param_attr_id=Vsq4ParameterNames.BRE.value,
                        value=point.y,
                    ),
                )
        ...
        music_controls.extend(
            [
                Vsq4MCtrl(
                    pos_tick=point.x + tick_prefix,
                    attr=Vsq4TypeParamAttr(
                        type_param_attr_id=Vsq4ParameterNames.GEN.value,
                        value=point.y,
                    ),
                )
        ...
        music_controls.extend(
            [
                Vsq4MCtrl(
                    pos_tick=point.x + tick_prefix,
                    attr=Vsq4TypeParamAttr(
                        type_param_attr_id=Vsq4ParameterNames.BRI.value,
                        value=point.y,
                    ),
                )
