...
from pure_protobuf.annotations import Field, int32
...
class Svip3Note(BaseMessage):
    start_pos: Annotated[int32, Field(1)] = 0
    width_pos: Annotated[int32, Field(2)] = 0
    key_index: Annotated[int32, Field(3)] = 0
    lyric: Annotated[str, Field(4)] = ""
    pronouncing: Annotated[str, Field(5)] = ""
    consonant_len: Annotated[int32, Field(6)] = 0
    has_consonant: Annotated[bool, Field(7)] = False
    user_consonant_len: Annotated[int32, Field(8)] = 0
    sp_len: Annotated[int32, Field(9)] = 0
    sil_len: Annotated[int32, Field(10)] = 0
    length_validate_tag: Annotated[int32, Field(11)] = 0
...
class Svip3SingingPattern(BaseMessage):
    ...
    real_pos: Annotated[int32, Field(3)] = 0
    real_dur: Annotated[int32, Field(4)] = 0
    play_pos: Annotated[int32, Field(5)] = 0
    play_dur: Annotated[int32, Field(6)] = 0
    is_mute: Annotated[bool, Field(7)] = False
    note_List: Annotated[list[Svip3Note], Field(8)] = field(default_factory=list)
    edited_pitch_line: Annotated[list[Svip3LineParamNode], Field(9)] = field(default_factory=list)
    edited_volume_line: Annotated[list[Svip3LineParamNode], Field(10)] = field(default_factory=list)
    edited_power_line: Annotated[list[Svip3LineParamNode], Field(11)] = field(default_factory=list)
    merge_pitch_line: Annotated[list[Svip3LineParamNode], Field(12)] = field(default_factory=list)
    merge_power_line: Annotated[list[Svip3LineParamNode], Field(13)] = field(default_factory=list)
...
class Svip3SingingTrack(BaseMessage):
    ...
    pattern_list: Annotated[list[Svip3SingingPattern], Field(8)] = field(default_factory=list)
    ai_singer_id: Annotated[str, Field(9)] = ""
    is_reverb_open: Annotated[bool, Field(10)] = False
    reverb_type: Annotated[int32, Field(11)] = 0
...
class Svip3BeatSize(BaseMessage):
    numerator: Annotated[int32, Field(1)] = 4
    denominator: Annotated[int32, Field(2)] = 4
...
class Svip3SongTempo(BaseMessage):
    pos: Annotated[int32, Field(1)] = 0
    tempo: Annotated[int32, Field(2)] = 0
...
class Svip3AudioTrack(BaseMessage):
    ...
    pattern_list: Annotated[list[Svip3AudioPattern], Field(8)] = field(default_factory=list)
...
class Svip3Project(BaseMessage):
    ...
    duration: Annotated[int32, Field(3)] = 0
    ...
    piano_cells: Annotated[int32, Field(9)] = 0
    loop_start: Annotated[int32, Field(10)] = 0
    loop_end: Annotated[int32, Field(11)] = 0
    is_open_adsorb: Annotated[bool, Field(12)] = True
    params_version: Annotated[int32, Field(13)] = 0
