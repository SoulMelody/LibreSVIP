...
def test_pinyin_01(pinyin_example):
...
def test_pinyin_02(pinyin_example):
...
def test_pinyin_03(pinyin_example):
...
def test_pinyin_04(pinyin_example):
...
def test_pinyin_05(pinyin_example):
...
def test_pinyin_06(pinyin_example):
...
def test_pinyin_07(pinyin_example):
...
def test_pinyin_08(pinyin_example):
